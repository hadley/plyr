...
\input{_include/b7aa1f7d6b74881a725e5ee1a3c1792b.tex}
% END
...
\input{_include/63b7326fa2c56a1b42d767ca7648c7eb.tex}
% END
...
\input{_include/daf4796bd5365ed29fcdae7edf1e0f0e.tex}
% END
...
% dim(coefs)
% dim(deseas)
\input{_include/20bc5f19f9ec08e48e08989140f945ae.tex}
% END
...
%  opts(aspect.ratio = 1)
\input{_include/89b6355349f8c2a53e879180252cdb1a.tex}
% END

% FIGURE
%  TEX-WIDTH: \textwidth  GG-WIDTH: 8  GG-HEIGHT: 8
%  LABEL: glyph-deseas
%  CAPTION: Star glyphs showing deasonalised trends.  
%
...
\input{_include/a9c5f88b0fbfd48fe28128bcbedafa68.tex}
% END
...
%     low="white", high=muted("red")) + map
% }
\input{_include/c979e53c6bf9ac0cd44dde3ff8d7f09d.tex}
% END
...
% monthsurface("Jan")
% monthsurface("Jul")
\input{_include/662f197eb2e529baa3efb7ab38593510.tex}
% END
