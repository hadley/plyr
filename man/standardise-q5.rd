...
\usage{standardise(x)}
\arguments{
\item{x}{matrix, array or data frame to be processed}
\item{}{a vector giving the subscripts to split up \code{data} by.  1 splits up by rows, 2 by columns and c(1,2) by rows and columns, and so on for higher dimensions}
\item{}{function to apply to each piece}
\item{}{other arguments passed on to \code{fun.}}
\item{}{name of the progress bar to use, see \code{\link{create_progress_bar}}}
\item{}{should extra dimensions of length 1 be dropped, simplifying the output.  Defaults to \code{TRUE}}
}
